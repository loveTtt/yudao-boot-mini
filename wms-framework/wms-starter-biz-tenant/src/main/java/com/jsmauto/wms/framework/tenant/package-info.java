 ...
 *      1）Spring Async：
 *          {@link com.jsmauto.wms.framework.quartz.config.AsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）登录上下文：
 *          {@link com.jsmauto.wms.framework.security.core.context.LoginUserContextHolder}
 *
 */
package com.jsmauto.wms.framework.tenant;
