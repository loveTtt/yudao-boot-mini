package com.jsmauto.wms.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${wms.websocket.sender-rocketmq.topic}",
        consumerGroup = "${wms.websocket.sender-rocketmq.consumer-group}",
