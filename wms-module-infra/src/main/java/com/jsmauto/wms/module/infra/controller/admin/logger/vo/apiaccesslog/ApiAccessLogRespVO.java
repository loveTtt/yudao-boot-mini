package com.jsmauto.wms.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.jsmauto.wms.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "jsmauto，牛逼！")
    @ExcelProperty("结果提示")
