package com.jsmauto.wms.framework.web.config;
...
import com.jsmauto.wms.framework.web.core.filter.CacheRequestBodyFilter;
import com.jsmauto.wms.framework.web.core.filter.DemoFilter;
import com.jsmauto.wms.framework.web.core.handler.GlobalExceptionHandler;
import com.jsmauto.wms.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class WebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "wms.demo", havingValue = "true")
