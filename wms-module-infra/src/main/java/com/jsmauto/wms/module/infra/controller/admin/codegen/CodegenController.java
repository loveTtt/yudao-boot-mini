package com.jsmauto.wms.module.infra.controller.admin.codegen;
...
import com.jsmauto.wms.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.jsmauto.wms.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.jsmauto.wms.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.jsmauto.wms.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.jsmauto.wms.module.infra.convert.codegen.CodegenConvert;
...
import com.jsmauto.wms.module.infra.service.codegen.CodegenService;
...
import static com.jsmauto.wms.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.jsmauto.wms.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "wms"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "芋道")
    })
    @SaCheckPermission("infra:codegen:query")
    ...
    @SaCheckPermission("infra:codegen:create")
    ...
    @PutMapping("/update")
    @SaCheckPermission("infra:codegen:update")
    ...
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @SaCheckPermission("infra:codegen:delete")
    ...
    @GetMapping("/preview")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @SaCheckPermission("infra:codegen:preview")
    ...
    @GetMapping("/download")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @SaCheckPermission("infra:codegen:download")
