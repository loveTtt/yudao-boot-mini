...
import com.jsmauto.wms.module.system.controller.admin.mail.vo.template.*;
import com.jsmauto.wms.module.system.dal.dataobject.mail.MailTemplateDO;
import com.jsmauto.wms.module.system.service.mail.MailSendService;
import com.jsmauto.wms.module.system.service.mail.MailTemplateService;
...
public class MailTemplateController {
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @SaCheckPermission("system:mail-template:query")
    ...
    @SaCheckPermission("system:mail-template:send-mail")
