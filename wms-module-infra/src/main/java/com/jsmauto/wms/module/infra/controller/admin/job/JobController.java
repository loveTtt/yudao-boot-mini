package com.jsmauto.wms.module.infra.controller.admin.job;
...
import com.jsmauto.wms.framework.quartz.core.util.CronUtils;
import com.jsmauto.wms.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import com.jsmauto.wms.module.infra.controller.admin.job.vo.job.JobRespVO;
import com.jsmauto.wms.module.infra.controller.admin.job.vo.job.JobSaveReqVO;
import com.jsmauto.wms.module.infra.dal.dataobject.job.JobDO;
import com.jsmauto.wms.module.infra.service.job.JobService;
...
public class JobController {
    ...
    @SaCheckPermission("infra:job:create")
    ...
    @SaCheckPermission("infra:job:update")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @SaCheckPermission("infra:job:delete")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @SaCheckPermission("infra:job:trigger")
    ...
    @SaCheckPermission("infra:job:export")
