package com.jsmauto.wms.framework.tracer.config;

import com.jsmauto.wms.framework.common.enums.WebFilterOrderEnum;
import com.jsmauto.wms.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "wms.tracer", value = "enable", matchIfMissing = true)
