package com.jsmauto.wms.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.jsmauto.wms.framework.common.util.json.JsonUtils;
import com.jsmauto.wms.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${wms.info.base-package}", annotationClass = Mapper.class,
