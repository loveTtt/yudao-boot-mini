package com.jsmauto.wms.module.infra.controller.admin.logger;
...
import com.jsmauto.wms.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogRespVO;
...
public class ApiErrorLogController {
    ...
    @SaCheckPermission("infra:api-error-log:update-status")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @SaCheckPermission("infra:api-error-log:query")
    ...
    @SaCheckPermission("infra:api-error-log:export")
