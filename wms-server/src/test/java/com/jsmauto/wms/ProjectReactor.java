...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.jsmauto.boot";
    private static final String ARTIFACT_ID = "wms";
    private static final String PACKAGE_NAME = "com.jsmauto.wms";
