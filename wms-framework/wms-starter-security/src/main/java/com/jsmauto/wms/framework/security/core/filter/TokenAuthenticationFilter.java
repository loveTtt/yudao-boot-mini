package com.jsmauto.wms.framework.security.core.filter;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.jsmauto.wms.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import com.jsmauto.wms.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
 ...
 * 验证通过后，获得 {@link LoginUser} 信息，并加入到当前请求上下文
 *
 * @author jsmauto
 */
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private LoginUser buildLoginUserByToken(String token, Integer userType) {
        ...
        try {
            accessToken = oauth2TokenApi.checkAccessToken(token);
        ...
        if (userType != null
            ...
            throw exception(FORBIDDEN, "错误的用户类型");
        }
        // 构建登录用户
