...
import com.jsmauto.wms.module.system.controller.admin.oauth2.vo.client.OAuth2ClientRespVO;
...
public class OAuth2ClientController {
    ...
    @SaCheckPermission("system:oauth2-client:create")
    ...
    @SaCheckPermission("system:oauth2-client:update")
    ...
    @SaCheckPermission("system:oauth2-client:delete")
    ...
    @SaCheckPermission("system:oauth2-client:query")
