package com.jsmauto.wms.framework.websocket.config;

import com.jsmauto.wms.framework.mq.redis.config.RedisMQConsumerAutoConfiguration;
import com.jsmauto.wms.framework.mq.redis.core.RedisMQTemplate;
import com.jsmauto.wms.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.jsmauto.wms.framework.websocket.core.listener.WebSocketMessageListener;
import com.jsmauto.wms.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.jsmauto.wms.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.jsmauto.wms.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.jsmauto.wms.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.jsmauto.wms.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.jsmauto.wms.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.jsmauto.wms.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.jsmauto.wms.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.jsmauto.wms.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.jsmauto.wms.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.jsmauto.wms.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.jsmauto.wms.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.jsmauto.wms.framework.websocket.core.session.WebSocketSessionManager;
import com.jsmauto.wms.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "wms.websocket", value = "enable", matchIfMissing = true) // 允许使用 wms.websocket.enable=false 禁用 websocket
...
public class WebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wms.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wms.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wms.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${wms.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wms.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${wms.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wms.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${wms.websocket.sender-kafka.topic}") String topic) {
