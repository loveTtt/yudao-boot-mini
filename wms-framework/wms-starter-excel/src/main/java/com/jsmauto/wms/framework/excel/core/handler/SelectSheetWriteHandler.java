package com.jsmauto.wms.framework.excel.core.handler;
...
import com.jsmauto.wms.framework.excel.core.annotations.ExcelColumnSelect;
import com.jsmauto.wms.framework.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    public SelectSheetWriteHandler(Class<?> head) {
        ...
        for (Field field : head.getDeclaredFields()) {
            // 关联 https://github.com/YunaiV/wms-asrs/pull/853
