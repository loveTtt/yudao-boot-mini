package com.jsmauto.wms.module.infra.controller.admin.demo.demo02;
...
import com.jsmauto.wms.module.infra.controller.admin.demo.demo02.vo.Demo02CategoryListReqVO;
import com.jsmauto.wms.module.infra.controller.admin.demo.demo02.vo.Demo02CategoryRespVO;
import com.jsmauto.wms.module.infra.controller.admin.demo.demo02.vo.Demo02CategorySaveReqVO;
import com.jsmauto.wms.module.infra.dal.dataobject.demo.demo02.Demo02CategoryDO;
import com.jsmauto.wms.module.infra.service.demo.demo02.Demo02CategoryService;
...
public class Demo02CategoryController {
    ...
    @SaCheckPermission("infra:demo02-category:create")
    ...
    @SaCheckPermission("infra:demo02-category:update")
    ...
    @SaCheckPermission("infra:demo02-category:delete")
    ...
    @SaCheckPermission("infra:demo02-category:query")
    ...
    @SaCheckPermission("infra:demo02-category:export")
