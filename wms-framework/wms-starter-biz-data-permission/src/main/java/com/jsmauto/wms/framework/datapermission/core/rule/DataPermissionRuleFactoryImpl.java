package com.jsmauto.wms.framework.datapermission.core.rule;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ArrayUtil;
import com.jsmauto.wms.framework.datapermission.core.annotation.DataPermission;
import com.jsmauto.wms.framework.datapermission.core.aop.DataPermissionContextHolder;
...
public class DataPermissionRuleFactoryImpl implements DataPermissionRuleFactory {
    ...
    public List<DataPermissionRule> getDataPermissionRule(String mappedStatementId) {
        ...
        // 1.4 特殊：数据翻译时，强制忽略数据权限 https://github.com/YunaiV/wms-asrs/issues/1007
        if (isTranslateCall()) {
            return Collections.emptyList();
        }
