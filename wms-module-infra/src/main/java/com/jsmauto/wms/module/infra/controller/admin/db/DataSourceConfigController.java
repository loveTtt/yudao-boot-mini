package com.jsmauto.wms.module.infra.controller.admin.db;

import com.jsmauto.wms.framework.common.pojo.CommonResult;
import com.jsmauto.wms.framework.common.util.object.BeanUtils;
import com.jsmauto.wms.module.infra.controller.admin.db.vo.DataSourceConfigRespVO;
...
public class DataSourceConfigController {
    ...
    @SaCheckPermission("infra:data-source-config:create")
    ...
    @SaCheckPermission("infra:data-source-config:update")
    ...
    @SaCheckPermission("infra:data-source-config:delete")
    ...
    @SaCheckPermission("infra:data-source-config:query")
