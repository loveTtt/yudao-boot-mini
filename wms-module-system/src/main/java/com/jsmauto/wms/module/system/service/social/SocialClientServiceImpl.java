package com.jsmauto.wms.module.system.service.social;
...
import com.jsmauto.wms.framework.common.util.cache.CacheUtils;
import com.jsmauto.wms.framework.common.util.http.HttpUtils;
import com.jsmauto.wms.framework.common.util.object.BeanUtils;
import com.jsmauto.wms.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.jsmauto.wms.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.jsmauto.wms.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import com.jsmauto.wms.module.system.dal.mysql.social.SocialClientMapper;
import com.jsmauto.wms.module.system.dal.redis.RedisKeyConstants;
import com.jsmauto.wms.module.system.enums.social.SocialTypeEnum;
import com.jsmauto.wms.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.jsmauto.wms.framework.common.util.collection.MapUtils.findAndThen;
import static com.jsmauto.wms.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.jsmauto.wms.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.jsmauto.wms.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${wms.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${wms.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/wms-cloud/pulls/230
