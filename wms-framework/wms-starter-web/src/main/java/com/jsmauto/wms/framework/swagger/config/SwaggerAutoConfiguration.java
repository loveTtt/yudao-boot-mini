package com.jsmauto.wms.framework.swagger.config;
...
import static com.jsmauto.wms.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
 ...
 * @author jsmauto
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关 https://github.com/YunaiV/wms-asrs/issues/954 讨论
...
public class SwaggerAutoConfiguration {
     ...
     *
     * @see <a href="https://github.com/YunaiV/wms-asrs/issues/957">app-api 前缀不生效，都是使用 admin-api</a>
     */
