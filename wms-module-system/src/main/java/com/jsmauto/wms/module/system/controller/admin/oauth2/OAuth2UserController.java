...
import com.jsmauto.wms.module.system.controller.admin.oauth2.vo.user.OAuth2UserInfoRespVO;
import com.jsmauto.wms.module.system.controller.admin.oauth2.vo.user.OAuth2UserUpdateReqVO;
 ...
 * 提供给外部应用调用为主
 *
 * 1. 在 getUserInfo 方法上，添加 @SaCheckScope("user.read") 注解，声明需要满足 scope = user.read
 * 2. 在 updateUserInfo 方法上，添加 @SaCheckScope("user.write") 注解，声明需要满足 scope = user.write
 *
 * @author jsmauto
 */
